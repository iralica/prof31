...
public class Lesson26 {
    public static void main(String[] args) throws IOException {
        ...
        // напоминаем себе что String Immutable, соответсвенно при добавлении
        // создается новый объект
        System.out.println(newName == name);

        // Есть альтернативныеметода рыботы
        ...
        System.out.println(builder == builder1);
        // изменение билдера не создает новый объект
        // если вы планируете делать много операцийй со стрингами то лучше использовать его
        ...
        // проверяет если с этим потоком работают сейчас, тогда он не даст одновременно это сделать
