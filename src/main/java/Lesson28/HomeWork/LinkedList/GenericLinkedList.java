...
import Lesson28.HomeWork.deque.GenericArrayDeque;
import Lesson8.list.MyLinkedList;

import java.util.Iterator;

public class GenericLinkedList <V> implements LinkedListGeneric<V> {
    ...
    public Iterator<V> iterator() {
        return new Iterator<>() {
            ...
            @Override
            public void remove() {
                GenericLinkedList.this.remove(position--);
            }
        };
    }
